/*
View Name:
  vw_fact_forecast_monthly_fy
Purpose:
  Provide a clean, reusable version of fact_forecast_monthly that includes
...
*/
CREATE OR REPLACE VIEW vw_fact_forecast_monthly_fy AS
SELECT
	f.*,
	CASE 
